...
public class ZipToCarrierLocalityParserTest {

    @Autowired
    private ZipToCarrierLocalityParser zipToCarrierLocalityParser;
    ...
    public void testFileParsing() throws Exception{
        ...
        List<BaseEntity> record=zipToCarrierLocalityParser.parse(file.getAbsolutePath());
        if(true){
