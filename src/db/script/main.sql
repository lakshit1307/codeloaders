...
CREATE TABLE T_PROCEDURE
   ...
   CREATE TABLE "T_ZIP_TO_CARRIER_LOCALITY"
      (	"EFF_START_DT" DATE NOT NULL ENABLE,
   	"EFF_END_DT" DATE,
   	"CARR_NBR" VARCHAR2(50 BYTE) NOT NULL ENABLE,
   	"LOCALITY_NBR" VARCHAR2(50 BYTE) NOT NULL ENABLE,
   	"CVC_TYPE_CD" VARCHAR2(2 BYTE) DEFAULT 'c' NOT NULL ENABLE,
   	"INST_ACTIVE_CD" VARCHAR2(1 BYTE) DEFAULT 'a' NOT NULL ENABLE,
   	"CONCEPT_FULFILLED_CD" VARCHAR2(1 BYTE) DEFAULT 't' NOT NULL ENABLE,
   	"TX_CNT" NUMBER NOT NULL ENABLE,
   	"LAST_TX_DT" TIMESTAMP (6) NOT NULL ENABLE,
   	"LAST_TX_USER_TXT" VARCHAR2(50 BYTE) NOT NULL ENABLE,
   	"ZIP_CD" VARCHAR2(10 BYTE) NOT NULL ENABLE,
   	"VERSION_START" NUMBER NOT NULL ENABLE,
   	"VERSION_END" NUMBER NOT NULL ENABLE,
   	"ACTION" VARCHAR2(50 BYTE) NOT NULL ENABLE,
   	 CONSTRAINT "T_ZIP_TO_CARRIER_LOCALITY_UK" UNIQUE ("ZIP_CD", "VERSION_START", "VERSION_END")
      );